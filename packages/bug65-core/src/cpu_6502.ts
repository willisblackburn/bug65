...
export class Cpu6502 implements Cpu {
    ...
    protected executeOpcode(opcode: number): void {
        ...
        switch (opcode) {
            ...
            case Opcode.LDA_izp: // 65C02
                this.LDA(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.LDX_abs:
            case Opcode.LDX_aby:
                this.LDX(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.LDY_abs:
            case Opcode.LDY_abx:
                this.LDY(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.STA_izp: // 65C02
                this.memory.write(effectiveAddr, this.A);
                break;

            case Opcode.STX_zp:
            case Opcode.STX_zpy:
            case Opcode.STX_abs:
                this.memory.write(effectiveAddr, this.X);
                break;

            case Opcode.STY_zp:
            case Opcode.STY_zpx:
            case Opcode.STY_abs:
                this.memory.write(effectiveAddr, this.Y);
                break;
            ...
            case Opcode.PLX_imp: this.PLX(); break; // 65C02
            case Opcode.PLY_imp: this.PLY(); break; // 65C02
            ...
            case Opcode.AND_izy:
            case Opcode.AND_izp:
                this.AND(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.ORA_izy:
            case Opcode.ORA_izp:
                this.ORA(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.EOR_izy:
            case Opcode.EOR_izp:
                this.EOR(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.BIT_abx: // 65C02
                this.BIT(this.memory.read(effectiveAddr));
                break;
            case Opcode.BIT_imm: // 65C02
                this.setFlag(Flags.Zero, (this.A & this.memory.read(effectiveAddr)) === 0);
                break;

            case Opcode.TRB_zp:
            case Opcode.TRB_abs:
                this.TRB(effectiveAddr); // 65C02
                break;
            case Opcode.TSB_zp:
            case Opcode.TSB_abs:
                this.TSB(effectiveAddr); // 65C02
                break;
            ...
            case Opcode.ADC_izy:
            case Opcode.ADC_izp:
                this.ADC(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.SBC_izy:
            case Opcode.SBC_izp:
                this.SBC(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.CMP_izy:
            case Opcode.CMP_izp:
                this.CMP(this.memory.read(effectiveAddr));
                break;

            case Opcode.CPX_imm:
            case Opcode.CPX_zp:
            case Opcode.CPX_abs:
                this.CPX(this.memory.read(effectiveAddr));
                break;

            case Opcode.CPY_imm:
            case Opcode.CPY_zp:
            case Opcode.CPY_abs:
                this.CPY(this.memory.read(effectiveAddr));
                break;
            ...
            case Opcode.ROR_abs:
            case Opcode.ROR_abx:
                this.ROR(effectiveAddr);
                break;

            // Branching
            case Opcode.BPL_rel: this.branch(!this.getFlag(Flags.Negative), effectiveAddr); break;
            case Opcode.BMI_rel: this.branch(this.getFlag(Flags.Negative), effectiveAddr); break;
            case Opcode.BVC_rel: this.branch(!this.getFlag(Flags.Overflow), effectiveAddr); break;
            case Opcode.BVS_rel: this.branch(this.getFlag(Flags.Overflow), effectiveAddr); break;
            case Opcode.BCC_rel: this.branch(!this.getFlag(Flags.Carry), effectiveAddr); break;
            case Opcode.BCS_rel: this.branch(this.getFlag(Flags.Carry), effectiveAddr); break;
            case Opcode.BNE_rel: this.branch(!this.getFlag(Flags.Zero), effectiveAddr); break;
            case Opcode.BEQ_rel: this.branch(this.getFlag(Flags.Zero), effectiveAddr); break;
            case Opcode.BRA_rel: this.branch(true, effectiveAddr); break; // 65C02
    ...
    protected ASL(addr: number): void {
    ...
    protected LSR(addr: number): void {
        let val = this.memory.read(addr);
    ...
    protected ROL(addr: number): void {
        let val = this.memory.read(addr);
    ...
    protected ROR(addr: number): void {
        let val = this.memory.read(addr);
    ...
    protected STZ(addr: number): void {
    ...
    public setRegisters(regs: Partial<CpuRegisters>): void {
        ...
        if (regs.Status !== undefined) this.Status = regs.Status;
    }
